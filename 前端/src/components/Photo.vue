  ...
  <div id="yyw-Photo">
    ...
    <div id="yyw-photo-list">
      <el-row>
        ...
        >
          <img
            src="../assets/yyw/icon/close.png"
            v-if="ispDelete"
            style="position:relative; left:132px; top:-32px; width:20px; height:20px; z-index:3; "
    ...
    <div id="yyw-view-photo" v-if="isView">
      ...
      <div class="yyw-right-block">
        ...
        <img
          src="../assets/yyw/icon/beforelike.png"
          class="yyw-icon-like"
          @click="addLikes"
          style="cursor:pointer"
          ref="likes"
...
export default {
  ...
  data() {
    return {
      ...
      getAjaxIfAdd: 0,
      token:
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ3d3ciLCJqdGkiOiJlYzkzMWQ3OS1kNmQzLTQzMDgtYjU4OC1iZjY3OTRkMDM1N2UiLCJleHAiOjE2MDAxNzc5MTQsImlzcyI6Imh0dHBzOi8vd3d3LmNuYmxvZ3MuY29tL2NoZW5ndGlhbiIsImF1ZCI6Imh0dHBzOi8vd3d3LmNuYmxvZ3MuY29tL2NoZW5ndGlhbiJ9.h8v0QBWWFM9C1MnIW8u9R3MvsV_yfY2-n6BHSWgkOk0",
      photos: [],
      photolist: [],
      comments: [],
    };
