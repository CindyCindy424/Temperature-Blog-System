<template>
  <div id="yyw-favorite">
    <img id="yyw-banner" src="../assets/yyw/images/banner.png" />
    ...
    <div id="yyw-left">
      ...
      <div id="yyw-favorite-list">
        <div class="yyw-f-item" v-for="item in favorite" :key="item.articleId">
          <router-link :to="{path:'/ViewArticle',query:{ViewArticleTitle:item.title,ViewArticleNickname:item.nickName,ViewArticleUsername:currentUserId}}"><span class="yyw-f-title">{{item.title}}</span></router-link>
          <router-link :to="{path:'/ViewArticle',query:{ViewArticleTitle:item.title,ViewArticleNickname:item.nickName,ViewArticleUsername:currentUserId}}"><span class="yyw-f-content">{{item.articleContent}}</span></router-link>
          ...
          <span class="yyw-f-answerCount">
            <img class="yyw-readnum" src="../assets/yyw/icon/eye(2).png" />
            {{item.readNum}}
          </span>
    ...
    getFC: function () {
      if (
        ...
        for (var i = 0; i < this.favorite.length; i++)
          this.favorite[i].articleUploadTime = this.favorite[
            i
          ].articleUploadTime.replace("T", " ");
      }
    },
